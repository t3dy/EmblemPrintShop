...

{
  ...
  images: [
    { id: "aurora-sapientia-bath", label: "Sapientia in the Bath", folio_or_plate: "fol. 1r", thumb_description: "A crowned woman immersed in a circular bath, attended by handmaidens — Wisdom (Sapientia) as the prima materia, the opening image of the Aurora Consurgens cycle." },
    { id: "aurora-conjunction", label: "Sol and Luna Conjunction", folio_or_plate: "fol. 13v", thumb_description: "The sun and moon personified as crowned monarchs, their hands joined — the coniunctio oppositorum at the heart of the alchemical Work." },
    { id: "aurora-philosophical-tree", label: "Philosophical Tree", folio_or_plate: "fol. 25r", thumb_description: "A flowering tree rising from a circular vessel, bearing flowers of gold and silver simultaneously — the growth of the Philosopher's Stone." },
...

{
  ...
  images: [
    { id: "ripley-toad", label: "The Crowned Toad — Prima Materia", folio_or_plate: "Upper register", thumb_description: "A crowned toad bled by three serpents (sulphur, mercury, salt) — the most distinctive opening image, the prima materia in its debased earthly state but with royal potential." },
    { id: "ripley-green-lion", label: "The Green Lion Swallowing the Sun", folio_or_plate: "Middle register", thumb_description: "The green lion devouring the solar disc — vitriol dissolving gold, one of the most reproduced images in the entire alchemical tradition." },
    { id: "ripley-pelican", label: "The Pelican Apparatus", folio_or_plate: "Middle register", thumb_description: "The pelican bird feeding her young with blood from her breast — the alchemical pelican-vessel in which distillate cycles back into the flask for redistillation." },
    { id: "ripley-ouroboros", label: "The Ouroboros with Crowned King", folio_or_plate: "Lower register", thumb_description: "A king contained within the ouroboros — the perfected stone enclosed within the eternal cycle, protected and self-contained." },
    { id: "ripley-phoenix", label: "The Phoenix Rising", folio_or_plate: "Base register", thumb_description: "The phoenix rising from flames — the final stage of the Work, the red stone reconstituted from destruction, the completion of the opus." }
  ],
  essay: {
...

{
  ...
  images: [
    { id: "dreifaltigkeit-trinity", label: "Alchemical Trinity Diagram", folio_or_plate: "Cgm 598, fol. 1r", thumb_description: "A diagrammatic image equating the Christian Trinity (Father, Son, Holy Spirit) with the alchemical triad of sulphur, mercury, and salt." },
    { id: "dreifaltigkeit-rebis", label: "The Rebis — Christ as Hermaphrodite", folio_or_plate: "Cgm 598, fol. 8v", thumb_description: "A hermaphroditic figure combining male and female elements, identified simultaneously with the resurrected Christ and the perfected Philosopher's Stone." },
    { id: "dreifaltigkeit-crucifixion", label: "Alchemical Crucifixion", folio_or_plate: "Cgm 598, fol. 15r", thumb_description: "Christ on the cross, with blood from the wounds flowing into an alchemical vessel — the Passion as the nigredo, the beginning of the Work." },
    { id: "dreifaltigkeit-tree", label: "Philosophical Tree of Metals", folio_or_plate: "Cgm 598, fol. 22v", thumb_description: "A symbolic tree whose roots are the four elements and whose branches bear the seven metals, a cosmological diagram unique to this text." }
  ],
  essay: {
...

{
  ...
  images: [
    { id: "flamel-angel", label: "Figure 1 — The Angel with the Book", folio_or_plate: "Figure 1", thumb_description: "An angel descending with an open book of divine alchemical wisdom — the opening figure framing the entire sequence as revealed knowledge." },
    { id: "flamel-dragons", label: "Figure 3 — Dragons Devouring Each Other", folio_or_plate: "Figure 3", thumb_description: "Two dragons consuming each other simultaneously — a double ouroboros, representing the reciprocal dissolution of sulphur and mercury in the prima materia." },
    { id: "flamel-mercury", label: "Figure 4 — Winged Mercury", folio_or_plate: "Figure 4", thumb_description: "Mercury with caduceus and winged feet — the mercurial principle as divine messenger and volatile spirit of the alchemical Work." },
    { id: "flamel-herod", label: "Figure 7 — King Herod's Massacre", folio_or_plate: "Figure 7", thumb_description: "A crowned king commanding soldiers to massacre children before a weeping woman — the destruction of the impure metals by mercury, the most disturbing image in the alchemical canon." },
    { id: "flamel-resurrection", label: "Figure 22 — Resurrection", folio_or_plate: "Figure 22", thumb_description: "The final figure: resurrection of the perfected Stone from the materials of the Work, completing the soteriological narrative." }
  ],
  essay: {
